    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-white/70 mb-4">@johndoe</p>
          ...
          <div className="flex space-x-8 mt-6">
            ...
            <div className="text-center">
              <div className="text-xl font-bold">24.5K</div>
        ...
        <Dialog open={isCreatePostOpen} onOpenChange={setIsCreatePostOpen}>
          <DialogTrigger asChild>
            <Button className="w-full mb-6 bg-white text-black hover:bg-white/90">
          ...
          <DialogContent className="bg-black border-white/20">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Label className="text-white">Invite Limit for this post</Label>
                <Input
                  type="number"
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-1">
            {userPosts.map((post) => (
              <div key={post.id} className="relative aspect-square bg-gray-800 rounded-lg overflow-hidden">
                <img 
                  src={post.thumbnail} 
                  alt={post.title}
